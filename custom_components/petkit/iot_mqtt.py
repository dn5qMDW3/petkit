...
class PetkitIotMqttListener:
    ...
    async def async_start(self) -> None:
        ...
        except Exception as err:  # noqa: BLE001 — third-party API; any error should disable listener gracefully
    ...
    async def _debounced_refresh(self) -> None:
        ...
        except Exception:  # noqa: BLE001 — coordinator refresh can raise arbitrary HA/API errors
